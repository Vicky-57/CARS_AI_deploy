...
PROJECT_REF = os.getenv("SUPABASE_PROJECT_REF", "wvzulyxzuntjnzdykstt")
REGION = "ap-south-1"
...
def apply_schema():
    ...
    for conn_str in CONN_STRINGS:
        ...
        try:
            ...
            print("SUCCESS: All tables (leads, projects, expenses, labor, meetings, communications, google_auth) created in Supabase!")
            cursor.close()
            conn.close()
            connected = True
            break
