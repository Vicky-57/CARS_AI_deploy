...
FIELD_MAP = {
    "buy_passiv": [
        ...
        {"key": "full_name", "box": [1, 148, 271, 295, 286], "size": 9.0},
        {"key": "phone", "box": [1, 402, 271, 550, 286]},
        {"key": "street", "box": [1, 148, 295, 295, 310]},
        {"key": "email", "box": [1, 402, 295, 550, 310]},
        {"key": "zip_city", "box": [1, 148, 320, 295, 335]},
        {"key": "id_card", "box": [1, 402, 320, 550, 335]},
        {"key": "salutation", "box": [1, 54, 270, 140, 286]},
        # search profile p1
        {"key": "manufacturer", "box": [1, 175, 672, 295, 688]},
        {"key": "model", "box": [1, 412, 672, 550, 688]},
        {"key": "fuel", "box": [1, 175, 692, 295, 708]},
        {"key": "gearbox", "box": [1, 412, 692, 550, 708]},
        {"key": "first_date", "box": [1, 175, 716, 295, 732]},
        {"key": "max_km", "box": [1, 412, 716, 550, 732]},
        {"key": "power", "box": [1, 175, 737, 295, 753]},
        {"key": "displacement", "box": [1, 412, 737, 550, 753]},
        {"key": "tuev_until", "box": [1, 175, 762, 295, 778]},
        {"key": "owners", "box": [1, 412, 762, 550, 778]},
        {"key": "wanted_colors", "box": [1, 175, 783, 295, 800]},
        {"key": "other_req", "box": [1, 412, 783, 550, 800]},
        # page 2 requirements
